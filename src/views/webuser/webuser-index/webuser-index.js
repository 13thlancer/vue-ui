layui.use(['admin', 'table', 'form', 'layer','whcomm','zTree'], function() {
	...
	*/
	 ...
	 * @param {Object} 
	 */
	function initPositionSelect(ele){
	 ...
	 * @param {Object} 
	 */
	function initManagerTypeSelect(ele){
